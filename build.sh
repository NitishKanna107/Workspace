...
SRC_DIR="./rtl/bcd_counter.v ./tb/bcd_counter_tb.v"                 # Directory where your Verilog source files are located
TOP_MODULE="bcd_counter"               # Top-level module name (edit this based on your design)
OUT_DIR="./build"              # Directory to store compiled files and waveform
WAVEFORM="bcdCount_sim.vcd"            # VCD file name for GTKWave
WAVECONFIG="bcdCount_config.gtkw"
